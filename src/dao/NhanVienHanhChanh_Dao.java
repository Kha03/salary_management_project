...
public class NhanVienHanhChanh_Dao {
    ...
    public List<NhanVienHanhChanh> getDanhSachNhanVienHanhChanh() {
        List<NhanVienHanhChanh> dsNhanVien = new ArrayList<NhanVienHanhChanh>();
